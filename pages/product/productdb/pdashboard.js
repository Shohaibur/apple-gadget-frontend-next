...
export default function ProductDashbord() {
  ...
  return (
    ...
    <MyLayout title="Product Dashbord"/>
    <main>
    {/* <Image src="/product.png" alt="me" width="64" height="64" />
      <div>
      <h1>product Dashboard</h1>
      <Link href="/profile"> Profile </Link><br></br><br></br><br></br>
      <button><Link href="/product/productdb/menu/menudisplay"> Menu </Link></button>
      <br></br><br></br>
      <button><Link href="/product/productdb/order/orderdisplay"> Order </Link></button>
      <br></br><br></br>
      <button><Link href="/product/productdb/table/tabledisplay"> Table</Link></button>
...
<aside class="flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
    <a href="#">
    <Image src="/product.png" alt="me" width="80" height="80" />
    </a>
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav class="-mx-3 space-y-6 ">
            ...
            <div class="space-y-3 ">
                ...
                <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="/product/productdb/menu/menudisplay">
                ...
                <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="/product/productdb/table/tabledisplay">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
