...
export default function TableDisplay() {
  const router = useRouter();
    return (
      ...
      <main>
        {/* <div>
        <button><Link href="/product/productdb/viewtable">View </Link></button>
        <button><Link href="/product/productdb/findtable">Find </Link></button>
        <button><Link href="/product/productdb/addtable">Add </Link></button>
        </div> */}
  ...
  <div class="container">
    <div class="bg-white rounded-lg shadow-lg p-5 md:p-20 mx-2">
      ...
      <div class="flex flex-wrap mt-10 justify-center">
        <div class="m-3">
          <a href="/product/productdb/viewtable"
        ...
        <div class="m-3">
          <a href="/product/productdb/findtable"
        ...
        <div class="m-3">
          <a href="/product/productdb/addtable"
